...
DROP INDEX IF EXISTS tx2_services_date_range_idx;
DROP INDEX IF EXISTS tx2_services_service_code_idx;
DROP INDEX IF EXISTS tx2_documents_modification_idx;
DROP INDEX IF EXISTS tx2_documents_file_name_idx;
...
DROP TABLE IF EXISTS tx2_documents;
