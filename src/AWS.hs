...
--                                                       _NotFoundException)
-- import           Amazonka.SNS.CreatePlatformEndpoint (cpersEndpointARN,
--                                                       createPlatformEndpoint)
-- import           Amazonka.SNS.DeleteEndpoint         (deleteEndpoint)
-- import           Amazonka.SNS.GetEndpointAttributes  (gearsAttributes,
--                                                       getEndpointAttributes)
-- import           Amazonka.SNS.Publish                (pMessageStructure,
--                                                       pTargetARN, publish)
-- import           Amazonka.SNS.SetEndpointAttributes  (seaAttributes,
--                                                       setEndpointAttributes)
-- import           Amazonka.Types                      (AWSRequest, Rs)
...
import           Types                 (DeviceType (..), PushPayload (..))
