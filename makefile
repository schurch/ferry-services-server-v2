...
.PHONY: tests
tests: test-env
	psql -d ferry-services-test -U stefanchurch -c 'DROP TABLE IF EXISTS vessels; DROP TABLE IF EXISTS service_locations; DROP TABLE IF EXISTS installation_services; DROP TABLE IF EXISTS installations; DROP TABLE IF EXISTS location_weather; DROP TABLE IF EXISTS locations; DROP TABLE IF EXISTS schema_migrations; DROP TABLE IF EXISTS days_of_non_operation; DROP TABLE IF EXISTS days_of_operation; DROP TABLE IF EXISTS vehicle_journeys; DROP TABLE IF EXISTS journey_patterns; DROP TABLE IF EXISTS lines; DROP TABLE IF EXISTS transxchangeservice_services; DROP TABLE IF EXISTS transxchange_services; DROP TABLE IF EXISTS operators; DROP TABLE IF EXISTS journey_pattern_timing_links; DROP TABLE IF EXISTS journey_pattern_sections; DROP TABLE IF EXISTS routes; DROP TABLE IF EXISTS route_links; DROP TABLE IF EXISTS route_sections; DROP TABLE IF EXISTS stop_points; DROP TYPE IF EXISTS day_of_week; DROP TABLE IF EXISTS serviced_organisation_working_days; DROP TABLE IF EXISTS serviced_organisations; DROP TABLE IF EXISTS services; DROP TABLE IF EXISTS organisations;'
