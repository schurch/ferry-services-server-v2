...
data Tx2JourneyPatternTimingLink = Tx2JourneyPatternTimingLink
  { tx2JourneyPatternTimingLinkId :: String,
    ...
    tx2JourneyPatternTimingLinkFromActivity :: String,
    tx2JourneyPatternTimingLinkFromTimingStatus :: String,
    tx2JourneyPatternTimingLinkToStopPointRef :: String,
    tx2JourneyPatternTimingLinkToActivity :: String,
    tx2JourneyPatternTimingLinkToTimingStatus :: String,
...
data Tx2VehicleJourney = Tx2VehicleJourney
  { tx2VehicleJourneyCode :: String,
    ...
    tx2VehicleJourneyWeekOfMonthRules :: [String],
    ...
    tx2VehicleJourneyBankHolidayNonOperationRules :: [String],
